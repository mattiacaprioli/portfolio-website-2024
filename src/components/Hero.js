      ...
      <div className='container mx-auto h-full'>
        <div className='flex items-center h-full pt-8'>
          ...
          <div className='flex-1 flex flex-col items-center lg:items-start'>
            ...
            <p className='pt-4 pb-8 md:pt-6 md:pb-12 max-w-[480px] text-lg text-center lg:text-left'>lorem di un grande vaffanculo e dovrò vedere cosa mettere qua dentro per riempire gli spazi vuoti!!</p>
